...
export default function SortableColumn({
    ...
    return (
        <div ref={setNodeRef} className="kanban-col group min-w-[310px] max-w-[310px] flex h-full flex-col overflow-hidden rounded-[26px] border border-slate-200/90 bg-white/82 shadow-[0_18px_44px_rgba(15,23,42,0.06)] backdrop-blur">
            <div className="column-header sticky top-0 z-10 flex items-center justify-between border-b border-slate-200/80 bg-white/80 p-4 font-medium">
            ...
            <div className="flex-1 space-y-3 overflow-y-auto p-3 min-h-[420px] bg-[linear-gradient(180deg,rgba(248,250,252,0.55),rgba(255,255,255,0.2))]">
                <SortableContext
